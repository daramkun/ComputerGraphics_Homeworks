...
int main(int argc, const char * argv[])
{
	...
	daram::mySetMatrixMode(daram::MatrixMode::MatrixMode_Projection);
	daram::myLoadIdentity();
	daram::myFrustum(0, 800, 600, 0, 1, 1000);
	std::cout << "-- MatrixMode - Projection (frustum) --" << std::endl;
	daram::showMatrix4x4 ( daram::getTopMatrix () );
	...
	daram::mySetMatrixMode(daram::MatrixMode::MatrixMode_Projection);
	daram::myLoadIdentity();
	daram::myOrtho(0, 800, 600, 0, 1, 1000);
	std::cout << "-- MatrixMode - Projection (ortho) --" << std::endl;
	daram::showMatrix4x4 ( daram::getTopMatrix () );
